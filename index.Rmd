...
> (1) General Introduction <br><br>

> (2) Part I - Pairs Trading <br>

  > + (2.1) Introduction to Pairs Trading <br>

  > + (2.2) Bayesian Method <br>

  > + (2.3) Non-Overlapping Block Bootstrap <br>
  
  > + (2.4) Conclusion <br><br>

> (3) Part II - Equipment Life-cycle Prediction <br>
  
  > + (3.1) Introduction to Reliability Theory <br>

  > + (3.2) Predicting Equipment Life-cycle in the Absence of Data <br>

  > + (3.3) Conclusion <br><br>
...
> __Positions:__ whenever the Z-score crosses $\mid \pm k\sigma \mid$ thresholds
...
--
> Backtest consisted of sliding window with 3 periods: formation | decision | trading; <br><br>
...
... after demonstrating that: (1) the bootstrap variance estimator correctly converges to the true variance $V$; and (2) the bootstrap estimator has the same asymptotic normality as the original OLS estimator $\sqrt{n} (\hat{\beta}_1 - \beta_1) \stackrel{d}{\to} \mathcal{N}(0, V)$:
...
## Part II - Equipment Life-cycle Prediction

---
###<font color =#4C5455><code> Introduction: __NBAF project__ </code></font>
...
<code> __Hypotheses:__  </code>
  ...
  > __(ii)__ enables model to learn from operational data that precedes failure 
...
\begin{equation}
    t_i \sim \mathit{Wei}(k_i, \lambda_i) \\
    \text{ }\\
...
> It integrates well with reliability theory; 
...
> Restrictions:<br>
  ...
  > + disproportional weight to expected life parmeter (prior and likelihood); 
...
> Future research: <br>
  ...
  > + Room to incorporate other environmental and operational factors;<br>
  > + Expand the hierarchical levels of the model;<br>
  > + Simulation and further empirical validation
